...
public abstract class Request<T> implements Comparable<Request<T>> {
    public interface SourceType {
        public static final int SOURCE_TYPE_CACHE_CLEAR = 0x0;
        public static final int SOURCE_TYPE_WEB = 0x1;
        public static final int SOURCE_TYPE_FILE = 0x2;
        public static final int SOURCE_TYPE_RES = 0x3;
    }
    ...
    /**
     * Request sourceType of this request. Currently supports web,res,file
     */
     ...
     * .
     */
    public Request(String url, int sourceType, Response.ErrorListener listener) {
        this(Method.DEPRECATED_GET_OR_POST, url, sourceType, listener);
    }
     ...
     * response.
     */
    public Request(int method, String url, int sourceType,
        ...
        if (sourceType == SourceType.SOURCE_TYPE_WEB) {
    ...
    public Request(int method, String url, int sourceType,
                   Response.ErrorListener listener, Resources resources) {
        this(Method.DEPRECATED_GET_OR_POST, url, sourceType, listener);
