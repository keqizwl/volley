...
public class DefaultImageCache implements ImageLoader.ImageCache {
    ...
    private DefaultImageCache(ImageCacheParams cacheParams) {
        init(cacheParams);
    }
     ...
     * not exist
     */
    public static DefaultImageCache getInstance(ImageCacheParams cacheParams) {
        cacheParams.memCacheSize = (int) (Runtime.getRuntime().maxMemory() / 8);
        DefaultImageCache imageCache = new DefaultImageCache(cacheParams);
        return imageCache;
    }
    ...
    /**
     * Adds a bitmap to both memory
     *
     * @param data  Unique identifier for the bitmap to store
     * @param value The bitmap drawable to store
     */
    public void putBitmapDrawable(String data, BitmapDrawable value) {
     ...
     */
    public BitmapDrawable getBitmapDrawable(String data) {
